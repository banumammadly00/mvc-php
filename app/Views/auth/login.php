          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form action="<?php echo SITE_URL ?>/auth/_login" method="post">
                    <?php if(isset($form_error)){ ?>
                    <div>
                    <span style="color: #ff5b60; font-size: medium; margin-bottom: 5%" ><?php echo $form_error; ?>
                    </div>
                    <?php } ?>
                    <?php if(isset($success)){ ?>
                        <div class="alert alert-success alert-dismissible fade show">
                            ...
                            <span><b> Success - </b><?php echo $success; ?></span>
                        </div>
                        <?php } ?>
                  ...
                  </form><small>Do not have an account? </small><a href="<?php echo SITE_URL ?>/auth/signup" class="signup">Signup</a>
                </div>
              </div>
            </div>
          </div>
